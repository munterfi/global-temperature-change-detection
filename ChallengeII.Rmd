...
# Plotting
par(mfrow=c(1,2))
plot(temp1970w.ok.pred, main="Predicted temperature")
plot(temp1970w.ok.var, main="Prediction uncertainty (variance)")
```
...
# Plotting
par(mfrow=c(1,2))
plot(temp1970s.ok.pred, main="Predicted temperature")
plot(temp1970s.ok.var, main="Prediction uncertainty (variance)")
```
...
# Plotting
par(mfrow=c(1,2))
plot(temp2010w.ok.pred, main="Predicted temperature")
plot(temp2010w.ok.var, main="Prediction uncertainty (variance)")
```
...
# Plotting
par(mfrow=c(1,2))
plot(temp2010s.ok.pred, main="Predicted temperature")
plot(temp2010s.ok.var, main="Prediction uncertainty (variance)")
```
