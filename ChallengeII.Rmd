...
plot(ocean.dist, main="Continentality")
lines(oceans, col="Grey")
```
...
temp1970w$lati <- coordinates(temp1970w)[,2]

# Linear Regression
temp1970w.lm.test <- lm(meansum~elev+cont+lati, data=temp1970w@data)
